			...
			<div align="center">
				<table border="1">
					...
					<s:iterator value="list">
						<tr>
							<td><input type="text" name="item.itemid"
								value="<s:property value='itemid'/>" readonly="readonly" /></td>
							<td><s:property value="voteid" /></td>
							<td><s:property value="label" /></td>
							<td><s:property value="content" /></td>
							<td><input type="text" name="item.count"
								value="<s:property value='count'/>" /></td>
						</tr>
					</s:iterator>
					<tr>
