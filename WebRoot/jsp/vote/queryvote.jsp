   	    ...
   	    <div align="center">
            ...
            <s:iterator value="list">
              <tr>
                ...
                <td><s:property value="classification"/>
                </td>
                <td><s:property value="publishdate"/>
                </td>
                <td><s:property value="finishdate"/>
                </td>
                <td><s:property value="avaliable"/>
                </td>
                <td><a href="mergevote.action?vote.voteid=<s:property value='voteid'/>">edit</a> <a href="deletevote.action?vote.voteid=<s:property value='voteid'/>">delete</a> </td>
              </tr>
            </s:iterator>
          </table>
   	    </div>
